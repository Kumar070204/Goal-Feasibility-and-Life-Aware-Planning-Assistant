<p align="center">
  <img src="web/public/globe.svg" alt="EON Logo" width="80" height="80" style="background: transparent;"/>
</p>

<h1 align="center">Goal Feasibility & Life-Aware Planning Engine</h1>

<p align="center">
  <strong>An Intelligent Full-Stack Decision Support System designed for EON Health to optimize habits around real-world calendar commitments.</strong>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Google%20Calendar-API%20v3-4285F4?style=for-the-badge&logo=googlecalendar&logoColor=white" alt="Google Calendar API Badge" />
  <img src="https://img.shields.io/badge/AI-Ollama%20%2F%20Gemma3-FF6F61?style=for-the-badge&logo=ollama&logoColor=white" alt="AI Badge" />
  <img src="https://img.shields.io/badge/Machine%20Learning-Greedy%20Optimization-009688?style=for-the-badge&logo=scikit-learn&logoColor=white" alt="ML Badge" />
  <img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License Badge" />
  <br/>
  <img src="https://img.shields.io/badge/Status-Production%20Ready-success?style=flat-square" alt="Status Badge" />
  <img src="https://img.shields.io/badge/Last%20Updated-June%202026-brightgreen?style=flat-square" alt="Last Updated Badge" />
  <img src="https://img.shields.io/badge/Demo-Available-blue?style=flat-square" alt="Demo Available Badge" />
</p>
...
| **Conflict Detection** | Multi-pass collision checking against calendar events. | Eliminates overlapping slots and scheduling conflicts. |
| **Time Optimization** | Packs multiple short habits sequentially into single blocks. | Maximizes efficiency and reduces calendar fragmentation. |
| **Balanced Scheduling** | Distributes habits across the entire week. | Sustains consistency over one-off bursts of activity. |
...
```mermaid
graph TD
    subgraph Google Calendar Cloud
        GCal[Google Calendar API v3]
    end

    subgraph EON Python Engine (EON_POC)
...
![Google Calendar Before EON Planning](assets/calendar_before.png)
*Figure 1: Sandbox primary calendar showing base commitments before scheduling.*
...
![Google Calendar After EON Planning](assets/calendar_after.png)
*Figure 2: Sandbox primary calendar after syncing EON's Morning Focused Plan.*
...
[![EON Project Demo Video](assets/calendar_after.png)](demo/demo.mp4)
...
│   ├── credentials.json            # Google OAuth OAuth 2.0 client configuration (ignored)
...
* **Ollama**: Installed and running locally for AI explanation features (optional; fallback will kick in if missing).
...
* **Possible Errors & Troubleshooting**:
  * *Error*: `FileNotFoundError: [Errno 2] No such file or directory: 'token.pkl'`
  * *Fix*: Execute a script like `free_slot_finder.py` first to trigger browser OAuth login and create the session token.
...
* **$\ge 70\%$ (Achievable)**: Color code green in UI. The engine assumes you have enough schedule buffer.
* **$< 70\%$ (Overload Detected)**: Color code red/orange. Warns the user that time limits are close, suggesting they scale down goals or sleep expectations.
...
* **Project Repository**: [GitHub Repo](https://github.com/Kumar070204/Goal-Feasibility-and-Life-Aware-Planning-Assistant)
* **Email**: [kumar070204@gmail.com](mailto:kumar070204@gmail.com)
